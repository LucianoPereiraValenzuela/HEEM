...
import time
import numpy as np
from GroupingAlgorithm import *  # TODO: Do not import all the functions
from HEEM_VQE_Functions import *  # TODO: DO not import all the functions
...
class VQE(MinimumEigensolver):
	...
	def __init__(self,
		...
		# TODO: Change this to the proper objects stored in the variables
		self._coeff = None
		self._label = None
		self._Groups = None
