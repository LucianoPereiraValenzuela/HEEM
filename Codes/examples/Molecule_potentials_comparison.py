...
def molecule_potentials_comparison(distances, quantum_instance, conectivity, file_name_out):
    ...
    results = Parallel(n_jobs=24)(delayed(molecule)(d, quantum_instance, conectivity) for d in distances)
...
# distances = [0.5, 1.5, 5]
distances = np.linspace(0.5, 5, 23)
...
start = time()
molecule_potentials_comparison(distances, qi, coupling_map, file_name_out)
finish = time()
